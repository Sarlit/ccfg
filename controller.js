...
angular.module('app').controller('AppController', function($scope, $http) {
  ...
  $scope.search = function() {
    ...
    var clientID = "53EBDWHCMVIEKE2SFVJGTMRZYTEBODLXLM0TQCR5YZ5EMXPT";
    var clientSecret = "HUV2RWXX5VPRP00EM5E0XSS3JOMX03MHNEFE5U1TZBJDMYF5";
  ...
  return {
    ...
    minus: minus,
    venueID: venue.id,
	//picture_url: "https://ccfg.disfrutandodelavida.es/img/no-picture.png",
...
angular.module('app').controller('DetailController', function($scope, $http) {
  $scope.mapClick = function() {
    window.location.href = "http://maps.google.com/maps?z=16&t=m&q=loc:" +
      $scope.lat + "+" + $scope.lng+"&key=AIzaSyCV7D4qK_LjQZh7cTi4oV2wEmk1EM2Y9i0";
  };
